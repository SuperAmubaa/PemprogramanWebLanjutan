...
$ray_agama = ['Islam','Kristen Protestan','Katolik', 'Hindu', 'Budha', 'Khonghucu'];
$obj = new Pegawai();
$rs = $obj->dataDivisi();
?>
...
<form method="POST" action="controllers/pegawaiController.php">
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="Nip" name="Nip" type="text" class="form-control" required="required" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="nama" name="nama" placeholder="Nama Anda!" type="text" class="form-control" required="required" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
        <label for="email" class="col-4 col-form-label">Email</label>
        <div class="col-8">
            <input id="email" name="email" placeholder="Email Anda!" type="email" class="form-control" required="required" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="foto" type="text" name="foto" class="form-control" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
